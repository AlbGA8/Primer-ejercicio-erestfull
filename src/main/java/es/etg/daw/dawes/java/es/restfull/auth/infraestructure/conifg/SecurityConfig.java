package es.etg.daw.dawes.java.es.restfull.auth.infraestructure.conifg;
...
import es.etg.daw.dawes.java.es.restfull.auth.infraestructure.db.jpa.repository.UserEntityRepository;
import es.etg.daw.dawes.java.es.restfull.auth.infraestructure.mapper.UserMapper;
...
public class SecurityConfig {
    ...
    // Configuración de seguridad comentada para permitir todas las solicitudes
