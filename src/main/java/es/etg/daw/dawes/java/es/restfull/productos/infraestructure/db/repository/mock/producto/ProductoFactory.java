package es.etg.daw.dawes.java.es.restfull.productos.infraestructure.db.repository.mock.producto;
...
public class ProductoFactory {
    ...
    public static final Producto create(){
        return new Producto(new ProductoId(1),"Producto", 2.10, LocalDateTime.now(), new CategoriaId(1));
    }
}
